...
export default function CheckIn({ close }) {
    ...
    const handlePrepaymentMore = (e) => {
        ...
        if (e.target.value > firstMustPay) {
            setError({ prepaymentMore: "Prepayment must be small than total" })
        } else {
            setMustPay(firstMustPay - e.target.value)
            setError({})
        }
    }
                        ...
                        <div className="row">
                            <div className='col-8'>
                                <div className="container">
                                    ...
                                    <div className='mt-3'>
                                        <h6>Surchage: {moneyFormat(surcharge)}</h6>
                                        <h6>Must Pay: {moneyFormat(mustPay)}</h6>
                                        <h1>Total: {moneyFormat(surcharge + mustPay)}</h1>
                                    </div>
                                </div>
                            </div>
                            <div className='col-4'>
