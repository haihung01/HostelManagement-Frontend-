          ...
          <div className="card-footer bg-white border-0 mb-4 p-2 text-center ">
            {
              (room.roomStatus.name === 'Unvaliable') && (
                <>
                  {/* Detail popup*/}
                  <button type="button" className="click-face-cpn-booking" data-bs-toggle="modal" data-bs-target="#detailpopup">Detail</button>

                  <div className="modal fade" id="detailpopup" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  ...
                  {/* Check out popup*/}
                  <button type="button" className="click-face-cpn-booking" data-bs-toggle="modal" data-bs-target="#checkoutpopup">Check Out</button>

                  <div className="modal fade" id="checkoutpopup" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div className="modal-dialog modal-fullscreen">
                      <div className="modal-content">
